...
import { changeLayoutMode, changeTopbarTheme } from 'slices/thunk';
import { useDispatch } from 'react-redux';
import { LAYOUT_MODE_TYPES } from 'Common/constants/layout';
import { LAYOUT_TOPBAR_THEME_TYPES } from "./constants/layout";
        ...
        <React.Fragment>
            <Dropdown className="topbar-head-dropdown ms-1 header-item" align="start">
                ...
                <Dropdown.Menu className="p-2 dropdown-menu-end" id="light-dark-mode">
                    ...
                    ><i className="bi bi-sun align-middle me-2"></i> Default (light mode)</Dropdown.Item>
                    ...
                    <Dropdown.Item href="#" data-mode="dark" onClick={() => dispatch(changeLayoutMode(LAYOUT_MODE_TYPES.BRANDMODE))}><i className="bi bi-award align-middle me-2"></i> Brand</Dropdown.Item>
