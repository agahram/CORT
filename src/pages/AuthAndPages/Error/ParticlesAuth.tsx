...
const ParticlesAuth = ({ children }: any) => {
  return (
    <React.Fragment>
      <section className="auth-page-wrapper bg-primary-subtle py-5 position-relative d-flex align-items-center justify-content-center min-vh-100">
        <Container>
          <Row className="justify-content-center">
            <Col lg={6}>
              <Card className="mb-0 p-2">
                <Row className="g-0">
                  {/* <Col xxl={5}>
                    <Card className="auth-card h-100 border-0 shadow-none d-none d-sm-block overflow-hidden mb-0"> */}
                  ...
                  {/* </div> */}
                  {/* <Card.Body className="py-5 d-flex justify-content-between flex-column h-100 position-relative gap-4">
                        <div className="text-center">
                          <h2 className="text-white fw-medium lh-base text-capitalize mb-3">
                        ...
                        <div className="text-center">
                          <p className="text-white text-opacity-75 mb-0 mt-3">
                            &copy; {new Date().getFullYear()} Judia. Crafted
                            with{" "}
